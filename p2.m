...
% Implementation note.
cond_p2_2 = all(abs(AAC_sum(idx_C1)) < 1e-10);  % Implementation note.
cond_p2_3 = all(abs(ACC_sum_1) < 1e-10);  % Implementation note.
cond_p2_4 = all(abs(ACC_sum_2(idx_C2)) < 1e-10);  % Implementation note.
